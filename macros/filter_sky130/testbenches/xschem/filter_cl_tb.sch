...
N 370 -620 370 -610 {lab=vip}
N 360 -610 370 -610 {lab=vip}
N 370 -530 370 -520 {lab=vin}
N 360 -530 370 -530 {lab=vin}
N 370 -520 370 -490 {lab=vin}
N 370 -490 430 -490 {lab=vin}
N 370 -650 370 -620 {lab=vip}
N 370 -650 430 -650 {lab=vip}
N 360 -570 420 -570 {lab=vcmi}
N 590 -230 590 -210 {
lab=vcmi}
N 590 -150 590 -130 {
lab=GND}
N 590 -130 590 -120 {lab=GND}
N 590 -250 590 -230 {lab=vcmi}
...
C {devices/code_shown.sym} -950 -1930 0 0 {name=STIMULI
only_toplevel=false
value="
...
remzerovec
write filter_cl_tb.raw
.endc"}
C {devices/lab_pin.sym} 1620 -660 1 0 {name=l16 sig_type=std_logic lab=voutp2
}
C {devices/lab_pin.sym} 1620 -480 1 1 {name=l17 sig_type=std_logic lab=voutn2
}
...
C {devices/lab_pin.sym} 590 -610 1 0 {name=p3 sig_type=std_logic lab=vipp}
C {devices/lab_pin.sym} 590 -530 3 0 {name=p4 sig_type=std_logic lab=vinn}
...
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 1330 -450 2 0 {name=l10 sig_type=std_logic lab=voutp1
}
C {devices/lab_pin.sym} 1330 -690 0 1 {name=l11 sig_type=std_logic lab=voutn1
}
...
C {amp.sym} 900 -750 0 0 {name=xamp1}
...
C {devices/vdd.sym} 1080 -690 0 0 {name=l7 lab=VDD}
C {devices/lab_pin.sym} 1040 -690 1 0 {name=p1 sig_type=std_logic lab=di_pon}
C {devices/gnd.sym} 1080 -430 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 930 -620 1 0 {name=p7 sig_type=std_logic lab=vi_ota_p}
C {devices/lab_pin.sym} 930 -520 1 1 {name=p8 sig_type=std_logic lab=vi_ota_n}
C {devices/lab_pin.sym} 1220 -610 1 0 {name=p9 sig_type=std_logic lab=vo_ota_n}
C {devices/lab_pin.sym} 1220 -530 3 0 {name=p10 sig_type=std_logic lab=vo_ota_p}
...
C {devices/lab_wire.sym} 490 -610 0 0 {name=l20 sig_type=std_logic lab=vip}
C {devices/lab_wire.sym} 490 -530 0 0 {name=l21 sig_type=std_logic lab=vin
}
...
C {devices/launcher.sym} 280 -880 0 0 {name=h2
descr="Annotate OP"
tclcommand="set show_hidden_texts 1; xschem annotate_op"}
C {devices/code_shown.sym} 50 -1040 0 0 {name=SAVE only_toplevel=true
format="tcleval( @value )"
value="
.include [file rootname [file tail [xschem get schname]]].save
"}
C {code.sym} 50 -960 0 0 {
name=TT_MODELS1
only_toplevel=true
format="tcleval( @value )"
value="
